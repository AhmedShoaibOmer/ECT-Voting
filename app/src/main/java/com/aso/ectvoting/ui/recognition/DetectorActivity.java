...
public class DetectorActivity extends CameraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currentUserFace = getIntent().getStringExtra("base64Face");
        String currentUserFullName = getIntent().getStringExtra("fullName");
        if(currentUserFace != null && currentUserFullName != null){
         detector.register(currentUserFullName, detector.recognizeImage(ImageUtils.getBitmapFromBase64String(currentUserFace), true).get(0));
        }
    }
...
/*            if (name.isEmpty()) {
    ...
    private void sendBase64Face(String base64Face) {
        Intent data = new Intent();
        data.putExtra("base64Face",base64Face);
